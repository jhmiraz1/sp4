      ...
      <>
        <nav>
          ...
          <div>
            ...
            >
              <li>
                <a className="active" herf="index.html">
                  {" "}
                  Home
                </a>
              </li>
              <li>
                <a herf="index.html">All Games</a>
              </li>
              <li>
                <a herf="index.html">Racing </a>
              </li>
              <li>
                <a herf="index.html"> Action</a>
              </li>
              <li>
                <a herf="index.html"> Survival</a>
              </li>
              <li>
                <a herf="index.html"> Combact</a>
              </li>
            </ul>
          </div>
